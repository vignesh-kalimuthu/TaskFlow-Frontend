        ...
        <div className="grid grid-col-1 xl:grid-col-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              ...
              <div className="sapce-y-2 sm:space-y-3">
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0, 3).map((task) => (
                  <div
                    ...
                    className="flex itesm-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg transition-colors duration-200 border border-transparent hover:border-purple-100"
                  >
